...
qq.extend(qq.FineUploader.prototype, {
    ...
    _onComplete: function(id, fileName, result, xhr){
		...
		//	document.getElementById('savediv').innerHTML= '<button class="btn btn-small btn-primary savebutton"  type="button">Save</button>';
		//	this._find(item, 'savebutton').setAttribute("rel",result.uploadName);
            ...
            if (this._classes.failIcon) {
				...
				//qq(this._find(item, 'savebutton')).hide();
            }
