...
?>
        <li class="<?= implode(' ', $classes) ?>"><a href="<?= ($href) ?>"><span class="i18n"><?= ($previous) ?></span></a></li>
<?php
        /**
...
?>
        <li class="number"><a href="<?= ($href) ?>"><span class="i18n-n"><?= ($current + $x - $leading) ?></span></a></li>
<?php
            }

            // print current page
?>
        <li class="number active"><a href="#"><span class="i18n-n"><?= ($current) ?></span></a></li>
<?php
...
?>
        <li class="number"><a href="<?= ($href) ?>"><span class="i18n-n"><?= ($current + $x + 1) ?></span></a></li>
<?php
            }
        }
...
?>
        <li class="<?= implode(' ', $classes) ?>"><a href="<?= ($href) ?>"><span class="i18n"><?= ($next) ?></span></a></li>
    </ul>
</div>
<?php
    }
