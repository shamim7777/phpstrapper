...
class Translate {
	...
	function __construct() {
		...
		$this->langDirectory = APP_PATH . '/languages';
	...
	private function setLang() {
		...
		//echo "sadasdasdasdasdas";
		//echo $this->langDirectory.$this->lang;
		bindtextdomain('video', $this->langDirectory );
		textdomain('video');

		//echo _e('Enter your intro text here');
